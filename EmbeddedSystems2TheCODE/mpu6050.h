...
#define MPU6050_AXOFFSET 0.02
#define MPU6050_AYOFFSET 0.05
#define MPU6050_AZOFFSET -0.2
...
/*
 * get raw accel data only
 */
extern void mpu6050_getRawAccelData(int16_t* ax, int16_t* ay, int16_t* az);
extern void mpu6050_getConvAccelData(double* axg, double* ayg, double* azg);
#endif
